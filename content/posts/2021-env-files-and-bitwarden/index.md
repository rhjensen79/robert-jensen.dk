...
![Bitwarden desktop application showing the interface for creating a new secure note with the name "zshenv" for storing environment variables](images/create_note.webp)
...
![Terminal window displaying the Bitwarden CLI login process with the session key export command being executed](images/login.webp)
...
![Terminal showing successful execution of the Bitwarden CLI command that retrieves environment variables from the secure note and writes them to the .zshenv file](images/working.webp)
